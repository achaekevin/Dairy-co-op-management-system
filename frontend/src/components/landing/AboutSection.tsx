        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-6">
              Founded with a vision to empower dairy farmers, our cooperative has grown to become 
              the leading dairy management platform in the region. We combine traditional cooperative 
              values with modern technology to deliver exceptional service to our members.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed mb-8">
              Through transparent operations, fair pricing, and comprehensive support services, 
              we help thousands of farmers build sustainable livelihoods while delivering 
              premium dairy products to consumers.
            </p>
